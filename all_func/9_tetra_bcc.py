...
def Tetra_BCC(a,c,r,center_atom_radius=0.5,resolution=50, folder='all_files'):
    ...
    def generate_solid_volume(resolution, position, T, atom_radius, center_atom_radius, a, c, plane_equation):
        ...
        # Vectorized grid computation (no loops)
        ...
        # Calculate sphere implicit functions
        values_list = [
            bravais_function(x, y, z, pos, atom_radius) for pos in positions[:-1]
        ]
        # Add center atom radius for last position (body center)
        ...
        for normal_vector, D in plane_equation.values():
            ...
            values[mask] = 1  # Remove points on plane
