...
import os
def Truss_FCCZ(a=1.,b=1.,c=1.,alpha=90,beta=90,gamma=90,d=0.05, resolution = 200, folder='all_files'):
# Define the cylinder function
    ...
    def generate_solid_volume(size, resolution, vertices, r):
        ...
        for start_index, end_index in corner_pairs + face_diagonals:
    ...
    filename = f"59Truss_FCCZ_{d:.2f}_{resolution}.stl"
