...
import os
def Truss_FCC(d=0.05,resolution = 200, folder='all_files'):
    ...
    def generate_solid_volume(size, resolution, vertices, r):
        ...
        for start_index, end_index in face_diagonals:
    ...
    # Parameters 
    r_range = np.linspace(0.05, 0.15, 10)  # Radius of cylinders
    

    a, b, c = 1, 1, 1 
    alpha,beta,gamma=90,90,90 # Dimensions of the parallelepiped
    ...
    filename = f"58Truss_FCC_{d:.2f}_{resolution}.stl"
