...
def Skeletal_Gyroid(C, a1,a2, resolution = 200, folder='all_files'):
    ...
    V, F = build_end_caps(V, F, tol=SNAP_TOL, kind='g', direction='normal',mode='skeletal')
    rotate(V,a1,a2,0) 
    filename = f"37skeletal_TPMS_Gyroid_{C:.2f}_{a1}_{a2}.stl"  # Format filename with the c value
