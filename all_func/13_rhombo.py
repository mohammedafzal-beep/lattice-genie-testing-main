...
import os
def Rhombo(a,b,c,r,alpha,beta,gamma, resolution = 200, folder='all_files'):
 ...
 # Angles in degrees
    ...
    filename = f"13Rhombo_{a:.1f}_{b:.1f}_{c:.1f}_{r:.2f}_{alpha}_{beta}_{gamma}_{resolution}.stl" 
