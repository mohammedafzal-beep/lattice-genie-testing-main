...
def Inverted_IWP(C, a1,a2, resolution = 200, folder='all_files'):
    ...
    V, F = build_end_caps(V, F, tol=SNAP_TOL, kind='iwp', direction='reverse',mode='skeletal')
    rotate(V,a1,a2,0) 
    filename = f"46Inverted_IWP_{C:.2f}_{a1}_{a2}.stl"  # Format filename with the c value
    ...
    scale = 2 * np.pi / size
    filename = f"46Inverted_IWP_{resolution}"
