...
SNAP_TOL = 1e-6
scale = 2 * math.pi
def Inverted_FKS(C, a1,a2, resolution = 200, folder='all_files'):
    ...
    V, F = build_end_caps(V, F, tol=SNAP_TOL, kind='fks', direction='reverse',mode='skeletal')
    rotate(V,a1,a2,0) 
    filename = f"49Inverted_FKS_{C:.2f}_{direction}_{a1}_{a2}.stl"  # Format filename with the c value
