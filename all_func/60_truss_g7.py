...
import os
def Truss_G7(a=1.,b=1.,c=1.,alpha=90,beta=90,gamma=90,d=0.05, resolution = 200, folder='all_files'):
    ...
    def generate_solid_volume(size, resolution, vertices, r):
        ...
        for start_index, end_index in corner_pairs + body_diagonals:
    ...
    filename = f"60Truss_G7_{d:.2f}_{resolution}.stl"
