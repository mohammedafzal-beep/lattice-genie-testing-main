...
import os
def Truss_BCCZ(d=0.05,resolution = 200, folder='all_files'):
    ...
    # Transformation matrix to define the parallelepiped
    ...
    filename = f"56Truss_BCCZ_{d:.2f}_{resolution}.stl"
