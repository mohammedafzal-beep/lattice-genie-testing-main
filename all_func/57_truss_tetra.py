...
import os
def Truss_Tetra(d=0.05,resolution = 200, folder='all_files'):
    ...
    def generate_solid_volume(size, resolution, vertices, r):
        ...
        for start_index, end_index in corner_pairs + face_diagonals + body_diagonals:
    ...
    filename = f"57Truss_Tetra_{d:.2f}_{resolution}.stl"
